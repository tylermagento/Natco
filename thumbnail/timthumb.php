...
if( !defined('THUMBNAIL') ) die('Access denied!');
/**
...
class timthumb {
	...
	public static function start($Width = 0, $Height = 0, $ImgLocation = ''){
		$tim = new timthumb($Width, $Height, $ImgLocation);
		$tim->handleErrors();
		$tim->securityChecks();
	...
	public function __construct($Width, $Height, $ImgLocation){
		...
		if($this->isURL){
			...
			/***** Change this because $_SERVER ['QUERY_STRING'] is empty in current system *****/
			//$this->cachefile = $this->cacheDirectory . '/' . FILE_CACHE_PREFIX . $cachePrefix . md5($this->salt . $this->localImageMTime . $_SERVER ['QUERY_STRING'] . $this->fileCacheVersion) . FILE_CACHE_SUFFIX;
			$this->cachefile = $this->cacheDirectory . '/' . FILE_CACHE_PREFIX . $cachePrefix . md5($this->salt . $this->localImageMTime . $this->ImageLocation . '_' . $this->NewHeight . '_' . $this->NewWidth . $this->fileCacheVersion) . FILE_CACHE_SUFFIX;
		}
	...
	protected function processImageAndWriteToCache($localImage){
		...
		$new_width = $this->NewWidth;
		$new_height = $this->NewHeight;
